    ...
    [
      ...
      h(
        ...
        [
          ...
          h('option', { value: 'DMn gurU Amrdws swihb jI' }, 'Amardas Sahib Ji'),
          h('option', { value: 'DMn gurU rwmdws swihb jI' }, 'Ramdas Sahib Ji'),
          h('option', { value: 'DMn gurU Arjn dyv jI' }, 'Arjun Dev Ji'),
          h('option', { value: 'DMn gurU hr goibMd swihb jI' }, 'Har Gobind Sahib Ji'),
          h('option', { value: 'DMn gurU hr rwey swihb jI' }, 'Har Rai Sahib Ji'),
          h('option', { value: 'DMn gurU hr ikRSx swihb jI' }, 'Har Krishan Sahib Ji'),
